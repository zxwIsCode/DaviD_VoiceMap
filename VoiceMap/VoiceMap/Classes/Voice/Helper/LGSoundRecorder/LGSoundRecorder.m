...
//    NSString *fileName = [NSString stringWithFormat:@"/voice.caf", [[NSDate date] timeIntervalSince1970] ];
    
//	self.recordPath = [self.recordPath stringByAppendingPathComponent:@"/voice.caf"];
    self.recordPath = [self.recordPath stringByAppendingPathComponent:@"/voice.wav"];
//    self.recordPath = [self.recordPath stringByAppendingPathComponent:@"/voice.mp3"];
