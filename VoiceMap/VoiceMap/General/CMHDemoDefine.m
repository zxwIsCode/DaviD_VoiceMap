...
// 红包
NSString *const kMainGetRedPacketsList = @"/index.php/adver/index_aj/regionid/2/page/"; // 获得红包列表的接口
...
NSString *const kGetAllRedPackets = @"/index.php/Adver/useAdv"; // 红包详情页获得已领所有红包的接口
